...
export default class Blowfish {
  private static readonly P_BOX: Uint32Array = Uint32Array.from([
  ...
  constructor(key: ArrayBuffer) {
    ...
    this.s = [
      Blowfish.S_BOX[0].slice(),
      Blowfish.S_BOX[1].slice(),
      Blowfish.S_BOX[2].slice(),
      Blowfish.S_BOX[3].slice(),
    ];
    this.p = Blowfish.P_BOX.slice();
    this.key = realKey;
